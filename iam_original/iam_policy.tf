...
/*
  Creates a new IAM Policy based on the contents provided in
  the roles map in variables.tfvars.json. It uses the role
  name and appends "-iam-policy" as an identifier and iterates
  over the respective key values to fill the contents for the
  tags information.
*/
